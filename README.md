...
👨‍👩‍👧‍👦 개발 인원 : 6명 (팀 프로젝트)
| 이름  | 역할  | 담당 기능               | Github Link                                      |
| --- | --- | -------------------------- | ------------------------------------------------- |
| 이주호 | 팀장  | 스터디 카페 및 관리자 스터디 카페 입정 등록 에디터| https://github.com/ljh1901|
| 서준범 | 팀원  | 스터디 및 스터디 LMS|https://github.com/JunBeomSeo|
| 김성지 | 팀원  | 관리자     |
...
- 기존 스터디 카페 예약 시스템과 멘토링 매칭 및 스터디와 추후 학습관리를
  ...
  ->  스터디 카페 온라인 결제 / 멘토링 / 스터디 및 학습관리를 하나로 통합한 플랫폼
